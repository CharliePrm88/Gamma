...
public class BaseController<S extends BaseService<T, M>, T extends BaseDao, M extends BaseDto> implements BaseApi<M> {
    ...
    @Override
    @PostMapping(value = Urls.FIND_BY_ID, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @DeleteMapping(value = Urls.FIND_BY_ID, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
